...
<body>
<div class="top_space"  style="height: 500px;"></div>
            ...
            <div class="row justify-content-center">
              <form method="post" action="../member/join_ok.do" @submit="submitForm()">
			    <table class="table">
			     ...
			     <tr>
			      <th class="text-right" width="40%">비밀번호 확인</th>
			      <td width="60%">
			       <input type="password" size=15 
			       class="input-sm" name="userPwd" ref="userPwd2" v-model="userPwd2"
			         @keyup="pwdValidate2()">
			     ...
			     <tr>
			      <th class="text-right" width="30%">성별</th>
			      <td width="70%">
			     ...
			     <tr>
			      <th class="text-right" width="30%">생년월일</th>
			      <td width="70%">
			     ...
			     <tr>
			      <th class="text-right" width="30%">소개</th>
			      <td width="70%">
